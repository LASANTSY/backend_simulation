const swaggerSpec = {
  openapi: '3.0.0',
  info: {
    title: 'API Mobilisation',
    version: '0.1.0',
    description: 'API pour la gestion des recettes, simulations et previsions. Les routes sont exposees sous /api.',
  },
  servers: [{ url: '/api', description: 'Serveur local (prefixe /api)' }],
  tags: [
